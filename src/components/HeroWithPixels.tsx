    ...
    <section className='relative min-h-screen flex items-center hero-section overflow-hidden'>
      ...
      <Container>
        <div className='relative z-40 container'>
          ...
          >
            <motion.span className={`${LEAD} text-center text-white/90 px-4 py-2 sm:px-6 sm:py-3 border border-white/20 rounded-full bg-white/5 backdrop-blur-sm mx-2 sm:mx-0`}>
              {subtitle}
            </motion.span>
          </motion.div>
